        ...
        with open(filename, newline='', encoding='ISO-8859-1') as csvfile:
            ...
            for row in r:
                ...
                if first_row:
                    first_row = False
                    continue
                # Ignore rows that have unique IDs that start with 80
                # These were introduced manually to be ignored
                if row[1].strip().startswith("80"):
                    continue
                ...
                if date_of_embarkation and contains_digits(date_of_embarkation):
                    ...
                    if date_of_embarkation.startswith("191"):
                        ...
                        #parsed_date_of_embarkation = None
                    else:
